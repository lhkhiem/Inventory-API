    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ledgers", x => x.Period);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LedgerId = table.Column<string>(type: "nvarchar(10)", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    Opening = table.Column<int>(type: "int", nullable: false),
                    Ending = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LedgerDetails", x => new { x.LedgerId, x.ProductId });
                    table.ForeignKey(
